...
- (void)setupViews
{
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.bounds.size.height - (D_ImagePreView_DefaultHeight+64)) style:UITableViewStylePlain];
